<?php
/**
 * Example of retrieving a rejected order list from the Marvelpress Order API
 *
 * @author Lewis Pollard 
 * @copyright Marvelpress Ltd. 2012
 */

$url            = "https://orders.marvelpress.com/orders/rejected/";
...
if($http_status == 200)
{
    // Result now contains associative array of rejected orders (limit 5)
    print_r($result);
}
else
{
